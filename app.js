...
var DEFAULT_QUESTIONS = [
  ...
  { id: 'daily-kind', category: 'Daily', question: 'Did I say the kind thing out loud?', hint: 'Never keep a kind thought to yourself. Say it — it costs nothing and can turn someone\'s week around.', frequency: 'daily', scale: '1-5', order: 8 },
  { id: 'daily-learn', category: 'Daily', question: 'Did I learn or create something?', hint: 'Something I can use, not just consume.', frequency: 'daily', scale: '1-5', order: 9 },
  { id: 'daily-stress', category: 'Daily', question: 'How did I handle stress?', hint: 'Move, breathe, or talk. Not eat.', frequency: 'daily', scale: '1-5', order: 10 },
  { id: 'daily-hard', category: 'Daily', question: 'Did I face something hard?', hint: 'The call, the conversation, the thing I keep postponing.', frequency: 'daily', scale: '1-5', order: 11 },
  { id: 'daily-smoke', category: 'Daily', question: 'Did I smoke?', hint: 'Every session resets the cycle. Clean break.', frequency: 'daily', scale: '1-5', order: 12 },
